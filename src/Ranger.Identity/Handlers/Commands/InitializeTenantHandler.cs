...
namespace Ranger.Identity.Handlers.Commands
{
    public class InitializeTenantHandler : ICommandHandler<InitializeTenant>
    {
        ...
        private readonly ILoginRoleRepository<RangerIdentityDbContext> loginRoleRepository;
        private readonly RangerIdentityDbContext identityDbContext;
        private readonly ILogger<InitializeTenantHandler> logger;

        public InitializeTenantHandler(IBusPublisher busPublisher, ILoginRoleRepository<RangerIdentityDbContext> loginRoleRepository, RangerIdentityDbContext identityDbContext, ILogger<InitializeTenantHandler> logger)
        {
        ...
        public async Task HandleAsync(InitializeTenant command, ICorrelationContext context)
        {
            ...
            logger.LogInformation($"New tenant login '{command.DatabaseUsername}' added to Identity database.");
            ...
            logger.LogInformation($"New Identity tenant initialized successfully.");
